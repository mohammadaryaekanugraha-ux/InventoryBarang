            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="post">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="nm_kat" name="nm_kat">
                </div>
                <div class="text-center">
                    <a href="kategori_produk.php" class="btn btn-warning" style="color: black; text-decoration: none;">Kembali</a>
